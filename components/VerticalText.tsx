...
const VerticalText = () => {
  return (
    <div className={cn("relative h-screen p-4 flex overflow-y-hidden  bg-[#B9A0FF] text-black font-normal korna_one", korna_one.className)} style={{ writingMode: 'vertical-lr' }}>
